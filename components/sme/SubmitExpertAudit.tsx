...
export default function SubmitExpertAudit({ productId, isSME }: SubmitExpertAuditProps) {
    ...
    return (
        <div className="mb-12 border border-sme-gold/30 bg-black/40 backdrop-blur-sm rounded-lg overflow-hidden">
            {/* Header */}
            <button
                onClick={() => setIsExpanded(!isExpanded)}
                className="w-full px-8 py-6 flex items-center justify-between hover:bg-sme-gold/5 transition-colors"
            >
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-sm text-bone-white/60 font-mono">
                            SME-Only • 9-Pillar Review System
                        </p>
                    </div>
                </div>
                <div className="text-bone-white/40">
                    {isExpanded ? '▼' : '▶'}
                </div>
            </button>
