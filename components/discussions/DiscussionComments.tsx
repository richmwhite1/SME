...
import { createDiscussionComment } from "@/app/actions/discussion-actions";
...
export default function DiscussionComments({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createDiscussionComment(discussionId, commentContent, discussionSlug);
      
      // Fetch the newly created comment immediately
      ...
      if (fetchError) {
        ...
        // Update local state with all comments including the new one
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold text-deep-stone">Comments</h2>
