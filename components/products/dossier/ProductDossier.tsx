...
export default function ProductDossier(props: ProductDossierProps) {
    return (
        <div className="space-y-16 pb-16">
            ...
            <section id="community-experience" className="scroll-mt-24">
            ...
            {/* 2. EVIDENCE & INSIGHTS */}
            <section id="evidence-insights" className="scroll-mt-24">
                <div className="mb-8">
            ...
            {/* 3. EXPERT AUDITS */}
            <section id="sme-deep-dive" className="scroll-mt-24">
                ...
                <div className="bg-forest-obsidian/30 border border-translucent-emerald/20 rounded-xl p-6 md:p-8">
                    <NinePillarDetail
            ...
            <section id="specs" className="scroll-mt-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 bg-white/5 rounded-xl p-6 md:p-8 border border-white/10">
