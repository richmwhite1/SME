...
export const TERMINOLOGY = {
    ...
    COMMUNITY_VALIDATION_SCORE: "Aggregated score based on verified contributions (upvotes count double, comments count 5x) from the wider community, representing weighted consensus and real-world usage.",
