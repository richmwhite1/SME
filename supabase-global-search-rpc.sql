...
-- =====================================================
-- Creates a function to search across protocols, discussions, and resource_library
-- Returns results with type, title, slug, and metadata
-- =====================================================
...
-- Add comment
COMMENT ON FUNCTION global_search IS 'Searches across protocols, discussions, and resource_library. Returns results with relevance scoring.';

-- =====================================================
-- COMPLETE
-- =====================================================
-- Run this SQL in Supabase SQL Editor to create
-- the global search RPC function.
-- =====================================================
