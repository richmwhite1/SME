...
CREATE TABLE IF NOT EXISTS products (
  ...
  serving_size TEXT,
  form TEXT,
  sme_review_count INTEGER DEFAULT 0,
  avg_sme_purity NUMERIC(3,1),
  avg_sme_bioavailability NUMERIC(3,1),
  avg_sme_potency NUMERIC(3,1),
  avg_sme_evidence NUMERIC(3,1),
  avg_sme_sustainability NUMERIC(3,1),
  avg_sme_experience NUMERIC(3,1),
  avg_sme_safety NUMERIC(3,1),
  avg_sme_transparency NUMERIC(3,1),
  avg_sme_synergy NUMERIC(3,1),
  created_at TIMESTAMPTZ DEFAULT NOW(),
  updated_at TIMESTAMPTZ DEFAULT NOW()
);
